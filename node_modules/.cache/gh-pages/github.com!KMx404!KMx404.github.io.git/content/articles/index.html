    ...
    <script type="application/ld+json">
{
    ...
    <script defer src="https://unpkg.com/@tryghost/portal@latest/umd/portal.min.js" data-ghost="https://aliabdaal.com/"></script><style> .gh-post-upgrade-cta-content,
.gh-post-upgrade-cta {
    display: flex;
...
<header class='c-header'>
  <div class='o-grid o-grid--center'>
    <div class='o-grid__col'>
      <div class='c-header__inner'>
        <div class='c-logo'>
            <a href='index.html'>
              <img class='c-logo__img' src='favicon.ico' alt='Mohamed E.Faleh'>
            </a>
        </div>
  ...
  <li class='c-nav__item'>
    <a href='index.html' class='c-nav__link '>📚  Articles</a>
  </li>
  <li class='c-nav__item'>
...
<article class='c-post no-image page'>
  
<header class='c-post-header'>
  <h1 class='c-post-header__title'>Comming Soon...</h1>

    <p class='c-post-header__excerpt'>in a short amount of Time I will start publising articles, making videos and get back to my projects.</p>
</header>
...
<li class='c-social-icons__item'>
      ...
      <div class='c-title-bar'>
        ...
        <a href='/how-to-study-for-exams-an-evidence-based-masterclass/' class='c-teaser'>
  <div class='c-teaser__content'>
    <h3 class='c-teaser__title'>Coming Soon...</h3>
    <time class='c-teaser__date' datetime='2020-09-22' title='22 September 2020'>25 Nov 2020</time>
  </div>
